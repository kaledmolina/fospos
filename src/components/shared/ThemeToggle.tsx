  ...
  return (
    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
      <Button
        ...
        size="icon"
        onClick={toggleTheme}
        className="w-10 h-10 rounded-full bg-muted hover:bg-accent transition-colors border border-border relative overflow-hidden group shadow-sm flex items-center justify-center p-0"
      >
